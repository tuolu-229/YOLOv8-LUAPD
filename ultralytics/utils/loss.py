...
from .metrics import bbox_iou, probiou, bbox_mpdiou, bbox_inner_iou, bbox_focaler_iou, bbox_inner_mpdiou, \
    bbox_focaler_mpdiou, wasserstein_loss, WiseIouLoss
...
#         return loss.mean(1).sum()
#
# # 位置损失：第一部分就是计算预测框与目标框之间的IoU，一如既往的采用CIoU损失。而第二部分就是DFL
# class BboxLoss(nn.Module):
#
#     def __init__(self, reg_max, use_dfl=False):
#         """Initialize the BboxLoss module with regularization maximum and DFL settings."""
